...
#Relacion entre nivel de conformidad y género

barplot(table(dr$'Nivel de conformidad',dr$'¿Qué tipo transporte usa?'),beside = TRUE, legend.text = TRUE,main = "Conformidad por tipo de medio de transporte",xlab = "Genero", ylab="Conformidad")
...
# Gráfico que permita analizar género, conformidad y tiempo usando tablas de contingencia
