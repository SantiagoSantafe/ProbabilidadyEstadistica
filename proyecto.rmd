...
## Conclusiones
Basado en los resultados del informe, se observa una marcada disparidad de género en el uso y satisfacción del transporte en Bogotá. Aunque las mujeres representan la mayoría de los usuarios de este servicio, muestran niveles de satisfacción significativamente más bajos en comparación con los hombres. Esta discrepancia puede atribuirse, en parte, a la persepción de inseguridad y al acoso al que están expuestas mientras hacen uso del sistema de transporte masivo de la capital (Universidad Militar Nueva Granada).
